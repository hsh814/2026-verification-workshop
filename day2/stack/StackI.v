(** * Linked-List Stack Implementation
    ...
    This file is supplied.  It uses only the public memory operations from
    Exercise 1: the stack proof must likewise use [MemA]'s specifications,
    never the concrete [MemI] state. *)
