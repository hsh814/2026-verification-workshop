(** * Concrete Fractional-Permission Memory Implementation

    Fractions are a property of the abstract client resources.  The concrete
    implementation is an ordinary finite map paired with an access counter. *)
