(** * A Small Memory Interface
    ...
    This file is supplied.  The workshop memory stores dynamically typed
    values.  Locations are natural numbers; [Vundef] is the value of a
    freshly allocated cell.  The other constructors are enough to encode the
    linked-list stack in the next exercise. *)
