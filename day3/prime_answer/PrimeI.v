...
From prime_answer Require Export LListHeader PrimeHeader.

(** Given prime calculator.  The linked-list module exposes only generic
    indexed operations; all divisibility logic lives in this client. *)
Module PrimeI. Section PrimeI.
  ...
  ***)
  ...
  (** The closed program calls the prime service and prints its result. *)
